...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		while (1)
		{
			...
			case 22:
				textBox2->Text += " V";
				log << "*The client introduced the symbol -> V \n";
			...
			case 23:
				textBox2->Text += " X";
				log << "*The client introduced the symbol -> X \n";
			...
			case 24:
				textBox2->Text += " Y";
				log << "*The client introduced the symbol -> Y \n";
